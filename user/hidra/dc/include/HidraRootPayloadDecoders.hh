...
public:
  ...
  virtual void Decode(const RootDetectorPayload& detector, std::vector<RootQuantity>& quantities,
...
public:
  ...
  void Decode(const RootDetectorPayload& detector, std::vector<RootQuantity>& quantities,
